    ...
    def write_AeroDyn15Polar(self):
        ...
        for afi in range(int(self.fst_vt['AeroDyn15']['NumAFfiles'])):
            ...
            if self.fst_vt['AeroDyn15']['af_data'][afi][0]['NumCoords'] != '0':
                f.write('@"{:}_AeroDyn15_Coords_{:02d}.txt"       {:<11} {:}'.format(self.FAST_namingOut, afi, 'NumCoords', '! The number of coordinates in the airfoil shape file. Set to zero if coordinates not included.\n'))
            else:
