...
class InputWriter_OpenFAST(object):
    ...
    def write_HydroDyn(self):
        ...
        for j in range(6):
            ...
            elif list_check(self.fst_vt['HydroDyn']['AddF0'][j],return_bool=True):
    ...
    def write_SubDyn(self):
        ...
        f.write('{:<22d} {:<11} {:}'.format(self.fst_vt['SubDyn']['OutCBModes'], 'OutCOSM', '- Output Guyan and Craig-Bampton modes (0: No output, 1: JSON output), (flag)\n'))
        f.write('{:<22d} {:<11} {:}'.format(self.fst_vt['SubDyn']['OutFEMModes'], 'OutCOSM', '- Output first 30 FEM modes (0: No output, 1: JSON output) (flag)\n'))
